...
const users = [
  {
    ...
    email: 'admin',
    password: '', // Will hash during setup
    role: 'admin',
    phone: '100',
...
const schemes = [
  ...
  },
  {
    ...
    benefits: {
      ...
      te: 'జీవనోపాధి మద్దతు కోసం నెлку ₹1500 ఆర్థిక సహాయం.'
    },
...
// Initialize hashed passwords for mock users
(async () => {
  users[0].password = await bcrypt.hash('AdminPassword123', 12);
})();
